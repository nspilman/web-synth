...
const { envelopeParameters } :IAudioContextParameters = getDefaultContextWrapperValues();
const EnvelopeReducer = (state: IEnvelopeParameters = envelopeParameters, action: AudioControllerAction) => {    
    switch (action.type) {
