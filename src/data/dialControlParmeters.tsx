...
export const gainParameters = createParametersObject(0, 1, "GAIN", 10);

export const octaveParameters = createParametersObject(1, 8, "OCTAVE");
...
export const envelopeDecayParameters = createParametersObject(1, 2000, "DECAY");
...
export const filterQParameters = createParametersObject(0.01, 20, "Q", 100);
...
export const oscCountParameters = createParametersObject(1, 2, "OSCILLATORS");
...
export const distortionParameters = createParametersObject(0, 10, "DISTORTION");
